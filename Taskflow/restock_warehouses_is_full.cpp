...
int is_backup_warehouse_full() { std::cout << "Is Backup Warehouse Full\n"; return 0; }
...
int main()
{
	...
	tf::Task is_backup_warehouse_full = taskflow.emplace(::is_backup_warehouse_full);
	...
	unlock_backup_warehouse.precede(is_backup_warehouse_full);
	is_backup_warehouse_full.precede(check_backup_warehouse, lock_backup_warehouse);
	...
	is_backup_warehouse_full.name("Is Backup Warehouse Full");
	...
	dumpToFile(taskflow, "restock_warehouses_is_full.dot");
